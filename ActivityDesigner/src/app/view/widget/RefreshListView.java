...
import app.listener.OnRefreshListener;
...
public class RefreshListView extends ListView implements OnScrollListener{
	...
	private void initFooter() {
		footerView = LayoutInflater.from(getContext()).inflate(R.layout.view_refresh_list_footer, null);
	...
	private void initHeader() {
		headerView = LayoutInflater.from(getContext()).inflate(R.layout.view_refresh_list_header, null);
